...
_G.packer_plugins = {
  ...
  ["asyncrun.vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/asyncrun.vim",
  ...
  ["nvim-toggler"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/nvim-toggler",
  ...
  ["papercolor-theme"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/papercolor-theme",
